...
!function (e) {
    ...
    e(window).on("load", function () {
        ...
        function t() {
            var t = e(".module-slides").superslides("current"), a = e(".slides-container li").eq(t);
        ...
        n.length >= 0 && (n.hasClass("bg-dark") ? o.addClass("header-light") : o.removeClass("header-light")), e(".onepage-nav").singlePageNav({
            ...
            before: function (t) {
                1 != s && (e(".flexslider .container").fadeOut(500).animate({opacity: "0"}, 500), t.slides.eq(t.currentSlide).delay(500), t.slides.eq(t.animatingTo).delay(500))
            },
            after: function (t) {
                a(), 1 != s && e(".flexslider .container").fadeIn(500).animate({opacity: "1"}, 500)
            },
            useCSS: !0
        ...
        e("a", r).on("click", function () {
            ...
            e(this).appear(function () {
                ...
                e(this).animate({width: t + "%"}), e(this).find(".pb-number-box").animate({opacity: 1}, 1e3), e(this).find(".pb-number").countTo({
                    from: 0,
                    to: t,
                    speed: 900,
                    refreshInterval: 30
            ...
            e(this).appear(function () {
                ...
                e(this).countTo({
                    from: 0, to: t, speed: 1500, refreshInterval: 10, formatter: function (e, t) {
            ...
            var a = e(this).data("twitter"), i = e(this).data("number"),
                s = {id: a, domId: "twitter-" + t, maxTweets: i, enableLinks: !0, showPermalinks: !1};
            twitterFetcher.fetch(s)
        }), e(".lightbox").magnificPopup({type: "image"}), e("[rel=single-photo]").magnificPopup({
            type: "image",
        ...
        }), e(".lightbox-video").magnificPopup({type: "iframe"}), e("a.product-gallery").magnificPopup({
            type: "image",
            gallery: {enabled: !0, navigateByImgClick: !0, preload: [0, 1]},
            image: {titleSrc: "title", tError: "The image could not be loaded."}
        }), e(function () {
            ...
            var t = /\[[^(\]\[)]*\]/g, a = e(this), i = Math.max(e(window).width(), window.innerWidth) > 736;
            if (a.length > 0) {
                var s, o = a[0].getAttribute("data-addresses").match(t), n = a[0].getAttribute("data-info").match(t),
                    r = a.data("icon"), l = a.data("zoom"), d = [];
                ...
                p.icon = r, a.gmap3({
                    map: {options: c},
                    marker: {
                        values: d, options: p, events: {
                            click: function (t, a, i) {
                                if (i.data) {
                                    var s = e(this).gmap3("get"), o = e(this).gmap3({get: {name: "infowindow"}});
                                    o ? (o.open(s, t), o.setContent(i.data)) : e(this).gmap3({
                                        infowindow: {
                                            anchor: t,
                                            options: {content: i.data}
                                        }
                                    })
                                }
                            }
            ...
            particles: {
                number: {
                    value: 60,
                    density: {enable: !0, value_area: 900}
                },
                color: {value: "#ffffff"},
                shape: {
                    type: "circle",
                ...
                opacity: {value: .3, random: !0, anim: {enable: !0, speed: 1, opacity_min: .1, sync: !1}},
            ...
            interactivity: {
                ...
                modes: {
                    grab: {distance: 260, line_linked: {opacity: .6}},
            ...
            particles: {
                ...
                size: {value: 7, random: !0, anim: {enable: !1, speed: 40, size_min: .1, sync: !1}},
            ...
            var a = this.hash, i = e(a);
            e("html, body").stop().animate({scrollTop: i.offset().top - o.height()}, 600, "swing"), t.preventDefault()
        }), e(window).scroll(function () {
        ...
        }, !1), e(".parallax").jarallax({speed: .4})
    })

// $('#note-form').keydown(function(e) {
//     if (e.keyCode == 13) {
//         $('#note-form').submit();
//     }
// };
